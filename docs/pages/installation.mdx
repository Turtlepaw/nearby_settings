...
```kotlin {2}
	dependencies {
	        implementation("com.github.Turtlepaw:nearby_settings:1.0.0")
	}
```
</Tabs.Tab>
  <Tabs.Tab>
...
<details>
<summary>If you're using Jetpack Compose, remember to add a `remember` block to the `NearbySettingsHost`</summary>
